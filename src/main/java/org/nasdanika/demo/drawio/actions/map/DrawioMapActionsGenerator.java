package org.nasdanika.demo.drawio.actions.map;
 ...
 *
 */
public class DrawioMapActionsGenerator {
...
//		}
	...
	public void generateContainer(String name, Context context, ProgressMonitor progressMonitor) throws Exception {
		...
		copy(new File(siteDir, name + "\\living-beings"), docsDir, true, cleanPredicate, null);
			...
			public void accept(File file, String path) {
				if (path.endsWith(".html")) {
					...
					try {	
						...
						JSONObject searchDocument = org.nasdanika.html.model.app.gen.Util.createSearchDocument(path, file, inspector, DrawioMapActionsGenerator.this::configureSearch);
	...
	public void generate() throws Exception {
		...
		String name = "living-beings.drawio";
